// 文件名：AuditLog.cs
// 
// 创建标识：温朋朋 2018-05-29 11:10
// 
// 修改标识：温朋朋2018-05-29 11:10
// 
// ------------------------------------------------------------------------------
...
{
    public class AuditLog:IEntity<long>
    {
        /// <summary>
        ...
        public static AuditLog CreateFromAuditInfo(AuditInfo auditInfo)
        {
            ...
            return new AuditLog
            {
                ...
                ExecutionTime = auditInfo.ExecutionTime.ToString(CultureInfo.InvariantCulture),
