...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            ...
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    (this.includeDem('other') ? '<a data-count="other">其他</a>' : '') + '</div>' +
                    '<div class="city-select-content">' +
                    '<div class="city-select province" data-count="province"></div>' +
                    (this.includeDem('city') ? '<div class="city-select city" data-count="city"></div>' : '') +
                    (this.includeDem('district') ? '<div class="city-select district" data-count="district"></div>' : '') +
                    (this.includeDem('other') ? '<div class="city-select other" data-count="other"></div>' : '') +
                    '</div></div>';
        ...
        defineDems: function () {
            ...
            $.each([PROVINCE, CITY, DISTRICT,OTHER], $.proxy(function (i, type) {
                if (!stop) {
                    this.dems.push(type);
                }
        ...
        bind: function () {
            ...
            if (this.$city) {
                this.$city.on(EVENT_CHANGE, (this._changeCity = $.proxy(function () {
                    // var result=this.isShowTab(DISTRICT);
                    // if(result){
                    //     this.output(DISTRICT);
                    //     this.tab(DISTRICT);
                    // }  
            ...
            if (this.$district) {
                this.$district.on(EVENT_CHANGE, (this._changeDistrict = $.proxy(function () {
                    // var result=this.isShowTab(OTHER);
                    // if(result){
                    //     this.output(OTHER);
                    //     this.tab(OTHER);
                    // }  
        ...
        //                     type === OTHER ? this.$district && this.$district.find('.active').data('code') : code
        //     );
        ...
        //         switch (type){
        //                case CITY:
        //                this.$city.parents(".city-select-wrap").find(".city-select-tab").find("a:eq(1)").toggle();
        //                this.$district.parents(".city-select-wrap").find(".city-select-tab").find("a:eq(2)").toggle();
        //                this.$other.parents(".city-select-wrap").find(".city-select-tab").find("a:eq(3)").toggle();
        //                this.clearfixTab(CITY);
        //                this.clearfixTab(DISTRICT);
        //                this.clearfixTab(OTHER);
        //                break;
        ...
        // clearfixTab:function(type){
        //     //var placeholders = this.placeholders;
        //     var $select = this['$' + type];
        //     $select.html(this.getList([], type));
        //     $select.data('item', null);
        // },
