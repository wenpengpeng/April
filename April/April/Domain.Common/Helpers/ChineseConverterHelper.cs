// 文件名：ChineseConverterToSpell.cs
// 
// 创建标识：温朋朋 2018-06-20 11:32
// 
// 修改标识：温朋朋2018-06-20 11:32
// 
// ------------------------------------------------------------------------------
...
namespace Domain.Common.Helpers
{
    public static class ChineseConverterHelper
    {
        ...
        /// <param name="isUppper">是否大写</param>
        /// <returns></returns>
        public static string ChineseConverterToSpell(this string chainessStr, int length, bool isUppper = false)
        {
            if (isUppper)
            {
                chainessStr = chainessStr.ToUpper();
            }
            var obj = Convert.ToChar(chainessStr);
            //英文
